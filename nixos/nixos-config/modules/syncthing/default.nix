    ...
    services = {
      ...
      nginx.virtualHosts."syncthing.${domains.home}" = mkIf cfg.proxied {
        ...
        locations."/" = {
          ...
          extraConfig = ''
            allow ${addresses.home.hosts.arch};
            allow ${addresses.home.hosts.nixos};
            allow ${addresses.home.hosts.desktop.ethernet};
            allow ${addresses.home.hosts.desktop.wifi};
            allow ${addresses.vpn.hosts.nixos};
            deny all;
          '';
        };
      };
